  ...
  return (
    <div className="bg-black text-brand-orange font-sora min-h-screen selection:bg-brand-orange selection:text-black">
      ...
      <header className="fixed top-0 w-full z-[100] bg-black border-b-4 border-brand-orange flex justify-between items-center px-6 md:px-16 h-20">
        <Link href="/" className="font-extrabold tracking-tighter text-2xl md:text-3xl border-r-4 border-brand-orange pr-6 h-full flex items-center select-none cursor-pointer">
          MASS SESSIONS
        </Link>
